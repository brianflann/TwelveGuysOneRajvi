...
export const managers = [
     ...
     }, 
  {
       ...
       "bio": "<center><p></p>The last member in, but her first member <i>in.</i> There can be only one.</center><p></p>Often hailed as the Vince Lombardi of the league, Coach Flann is also holds the esteemed title as the Chief Executioner Officer (CEO) of Dead Guy Rosters Inc. A firm most recently known for the 2024 assassinations of not one, but <i>two</i> prominent Chiefs in a single season; a feat that has never been done before. The prior achievement of ending J.K. 6th-round-keeper Dobbins's 2021 season before it even started simply pales in comparison to <i>The Massacre of 2018</i>; a blood smeared campaign which resulted in successfully neutralizing the seasons of Devonta Freeman(1.12), Dalvin Cook(2.01), and Leonard Fournette(3.12) all before the autumn wind blew a single leaf from a tree.",
