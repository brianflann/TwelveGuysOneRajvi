...
export const managers = [
    {
       ...
       "bio": "<p>In the rugged, often unforgiving streets of North Wales, a young boy named Bis grew up amidst challenges that would forge a spirit of resilience within him.</p> <p> His early life was a testament to the powerful imagery found in Tupac Shakur's poignant poem, \"The Rose That Grew From the Concrete.\" Like the rose, Bis blossomed against all odds, drawing strength from the very environment that sought to limit him.</p> His intellect and determination, honed by the grit of his surroundings, propelled him towards an extraordinary path. Defying expectations, Bis earned a coveted spot at Bloomsburg University, one of the most prestigious colleges in the United States. There, he not only excelled academically but also broadened his horizons, proving that talent and tenacity know no geographical bounds. Life continued to unfold with remarkable turns. Just last year, Bis showcased his indomitable spirit in a different arena: fantasy football. His team, facing an abysmal 0-5 start, seemed destined for the league's cellar. Yet, with a blend of strategic brilliance and sheer will, Bis orchestrated the most inspiring comeback season the league had ever witnessed. Week after week, his team clawed its way back, defying statistical probabilities and silencing doubters, ultimately culminating in a triumphant championship victory. It was a season that mirrored his own life's journey – a testament to never giving up, no matter how bleak the initial outlook. Today, Bis stands as a man who has truly cultivated his own garden. He is happily married, a devoted husband and a proud father to two wonderful children, building a life rich in love and accomplishment. His story is a powerful reminder that even from the hardest ground, a beautiful and unyielding bloom can emerge.",
       ...
       "rival": {
         ...
         link: "399301755705286656", // manager array number within this array, or null to link back to all managers page
     ...
     },
  {
       ...
       "rival": {
         ...
         link: "399005414806564864", // manager array number within this array, or null to link back to all managers page
         image: "/managers/rival.jpg", // either a specific manager photo or '/managers/everyone.png' or '/managers/question.png'
       },
     ...
     }, 
   {
       ...
       "rival": {
         ...
         link: "399011015372570624", // manager array number within this array, or null to link back to all managers page
         image: "/managers/rival.jpg", // either a specific manager photo or '/managers/everyone.png' or '/managers/question.png'
       },
     ...
     },
  {
       ...
       "rival": {
         ...
         link: "398647852097622016", // manager array number within this array, or null to link back to all managers page
         image: "/managers/rival.jpg", // either a specific manager photo or '/managers/everyone.png' or '/managers/question.png'
       },
     ...
     },
  {
       ...
       "mode": "Win Now", // (optional) 'Win Now', 'Dynasty', or 'Rebuild' (anything else and you will need to add a new png to /static/ similar to the 'Rebuild.png' and 'Win Now.png' currently in there)
       "rival": {
         name: "Steven Tribanis", // Can be anything (usually your rival's name)
         link: "399010870270672896", // manager array number within this array, or null to link back to all managers page
         image: "/managers/rival.jpg", // either a specific manager photo or '/managers/everyone.png' or '/managers/question.png'
       },
     ...
     },
    {
       ...
       "rival": {
         ...
         link: "301226973785518080", // manager array number within this array, or null to link back to all managers page
         image: "/managers/rival.jpg", // either a specific manager photo or '/managers/everyone.png' or '/managers/question.png'
       },
       "favoritePlayer": 1426, // (optional) this corresponds to the Sleeper player ID (https://api.sleeper.app/v1/players/nfl)
      "valuePosition": "WR", // (optional) Favorite position (QB, WR, RB, TE, etc.)
     ...
     },
  {
       ...
       "rival": {
         ...
         link: "400391736628613120", // manager array number within this array, or null to link back to all managers page
         image: "/managers/rival.jpg", // either a specific manager photo or '/managers/everyone.png' or '/managers/question.png'
       },
       "favoritePlayer": 1426, // (optional) this corresponds to the Sleeper player ID (https://api.sleeper.app/v1/players/nfl)
      "valuePosition": "WR", // (optional) Favorite position (QB, WR, RB, TE, etc.)
     ...
     },
  {
       ...
       "rival": {
         ...
         link: "398953547510587392", // manager array number within this array, or null to link back to all managers page
         image: "/managers/rival.jpg", // either a specific manager photo or '/managers/everyone.png' or '/managers/question.png'
       },
     ...
     },
   {
       ...
       "name": "Commissioner Nick Ruggieri",
       //"tookOver": null, // (DEPRECATED! You don't need to use this anymore) (optional) used if a manager took over a team, delete this line or change to null otherwise
       ...
       "rival": {
         ...
         link: "337730755755008000", // manager array number within this array, or null to link back to all managers page
         image: "/managers/rival.jpg", // either a specific manager photo or '/managers/everyone.png' or '/managers/question.png'
       },
     ...
     },
   {
       ...
       "rival": {
         ...
         link: "398953389733457920", // manager array number within this array, or null to link back to all managers page
         image: "/managers/rival.jpg", // either a specific manager photo or '/managers/everyone.png' or '/managers/question.png'
       },
       "favoritePlayer": 1426, // (optional) this corresponds to the Sleeper player ID (https://api.sleeper.app/v1/players/nfl)
      "valuePosition": "WR", // (optional) Favorite position (QB, WR, RB, TE, etc.)
