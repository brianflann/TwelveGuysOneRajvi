...
export const managers = [
     ...
     },
  {
       ...
       "bio": "<p></p>\“The Eternal Sixth Seed:<i>A Norristown Fantasy Saga</i>\"<p></p>In the gritty heart of Norristown, PA, where football dreams are born in diners and decided in living rooms, one team lives perpetually on the edge — not of greatness, but of playoff mediocrity.<p></p>They call him The Sixth Seed — every year, without fail, he claws his way into the postseason with just enough fire to burn, but never enough to blaze. It’s not luck, it’s a lifestyle. His team rides the fine line between brilliance and breakdown, chaos and consistency. And it’s all by design.",
