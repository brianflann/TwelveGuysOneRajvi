...
export const homepageText = `
  ...
  to deliver unrivaled drama to its members and their families that HBO screenwriters could simply only dream of.</p>
  ...
  cash prize is lucrative indeed. However, the glory of hoisting the sacred Rajvi and relishing in her eternal beauty is a prize that transcends the plebeian construct of monetary value.</p>
  <p>   </p>
...
export const managers = [
    {
       ...
       "rival": {
         ...
         image: "/managers/Keefer.jpg", // either a specific manager photo or '/managers/everyone.png' or '/managers/question.png'
       },
      ...
      "rookieOrVets": "Rookies", // (optional) 'Rookies' or 'Vets' (anything else and you will need to add a new png to /static/ similar to the 'Rookies.png' and 'Vets.png' currently in there)
       "philosophy": "<center><p></p>Trade Everyone.</center>", // (optional)
     ...
     }, 
  {
       ...
       "bio": "<center><p></p>The last member in, but her first member <i>in.</i> There can be only one.</center><p></p>Often hailed as the Vince Lombardi of the league, Coach Flann also holds the esteemed title of Chief Executioner Officer (CEO) of Dead Guy Rosters Inc. A firm most recently known for the 2024 assassinations of not one, but <i>two</i> prominent Chiefs in a single season; a feat that has never been done before. The prior achievement of ending J.K. 6th-round-keeper Dobbins's 2021 season before it even started simply pales in comparison to <i>The 3 RB Massacre of 2018</i>; a blood smeared campaign which resulted in successfully neutralizing the seasons of Devonta Freeman(1.12), Dalvin Cook(2.01), and Leonard Fournette(3.12) all before the autumn wind blew a single leaf from a tree.<p></p>Aside from frantically patchworking his team back to life during the season, Coach Flann leads a well-rounded and active personal life. He finds joy in traveling to new places, which allows him to gain fresh perspectives outside of the game. He values activities that bring him companionship and relaxation away from the demands of coaching, such as spending quality time with his dog, attending concerts and engaging in a bit of playful trolling during the height of Eagles games. Soup szn does require stirring the pot after all.<p></p>At various points throughout the season Coach Flann may appear unassumingly far off in your rearview mirror. He may even appear buried. But his glorious rise from the ashes of 6 & 7 seed mediocrity to once again summit Mt. Raj is imminent. You, of course, know how the adage goes… <i>Objects in the mirror are closer than they appear.</i><center><p></p><b>Resurrection Sunday is near.</b></center>",
      ...
      "rookieOrVets": "Vets", // (optional) 'Rookies' or 'Vets' (anything else and you will need to add a new png to /static/ similar to the 'Rookies.png' and 'Vets.png' currently in there)
       "philosophy": "<center><p></p><i>All I have in this world are my balls and my word and I don't break them for no one.</i></center>", // (optional)
     ...
     },
  {
      ...
      "valuePosition": "WR", // (optional) Favorite position (QB, WR, RB, TE, etc.)
      "rookieOrVets": "Rookies", // (optional) 'Rookies' or 'Vets' (anything else and you will need to add a new png to /static/ similar to the 'Rookies.png' and 'Vets.png' currently in there)
       "philosophy": "<p></p>Draft elite talent early without missing and go get your guys when the time is right.", // (optional)
     ...
     },
  {
       ...
       "rival": {
         ...
         image: "/managers/Gevirtz.jpg", // either a specific manager photo or '/managers/everyone.png' or '/managers/question.png'
       },
