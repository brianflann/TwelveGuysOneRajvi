...
export const managers = [
     ...
     }, 
  {
       ...
       "bio": "<center><p></p>The last member in, but her first member <i>in.</i> There can be only one.</center><p></p>Chief Executioner Officer of Dead Guy Rosters Inc. Most recently known for the 2024 annihilation of not one, but <i>two</i> prominent Chiefs in a single season; a feat that has never been done before. The prior achievement of ending J.K. 6th-round-keeper Dobbins's 2021 season before it even started simply pales in comparison to the bloodsoaked 2018 campaign which resulted in successfully neutralizing the seasons of Devonta Freeman(1.12), Dalvin Cook(2.1), and Leonard Fournette(3.12) all before the autumn wind blew a single leaf from a tree.",
